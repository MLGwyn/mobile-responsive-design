...
const FeatureSection = () => {
  return (
    <div className="flex justify-center">
      <div className="w-full max-w-6xl flex-col px-4">
        <div className="font-pontano text-violet-900 text-2xl text-center">Proudly Disappointing Users, Since 2024</div>
        <div className="flex flex-wrap justify-center py-16"><FeatureItem
